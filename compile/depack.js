...
class ta extends ja {
  constructor(a) {
    const {binary:b = !1, rs:c = null, ...d} = a || {}, {M:e = K(!0), proxyError:f} = a || {}, g = (k, h) => e(h);
    super(d);
    this.a = [];
    this.I = new Promise((k, h) => {
      this.on("finish", () => {
        let l;
...
const Ua = async(a, b, c = {}) => {
  ...
  if (g) {
    ...
    return {entry:w("", k), packageJson:w("", f), ...h ? {version:h} : {}, packageName:l, ...m ? {hasMain:!0} : {}, ...n ? {} : {entryExists:!1}, ...p};
  }
  if ("/" == a && !g) {
...
const Jb = (a, b) => {
  ...
  return d.reduce((g, {re:k, replacement:h}) => g.replace(k, h.bind(f)), a);
}, Kb = (a, b, c = !1) => {
  const d = Jb(a, b);
  if (c) {
    return d;
...
*/
module.exports = (a = {}) => {
  const b = Gb(), {pragma:c = 'const { h } = require("preact");', noWarning:d = !1, matcher:e, ignoreNodeModules:f} = {...a, ...b};
